            ...
            <div class="profile-posts-container">
                    ...
                    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                        ...
                        <div class="post" id="post-<?php echo $post_id; ?>">
                            <div class="post-info">
                                ...
                                <?php
                                    date_default_timezone_set('America/Santiago'); // Replace 'Your_Timezone' with your actual timezone
                ...
                <script>
                    ...
                    function editPost(postId) {
                        showNotification('Función de edición de publicaciones no implementada.', 'info');
                    }
